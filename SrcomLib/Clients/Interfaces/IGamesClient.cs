...
{
    /// <summary>
    /// Interface for starting building a Game request
    /// </summary>
    public interface IGamesClient
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        IGamesClientIdQuery WithId(string id);
        ...
        /// <returns></returns>
        IGamesClient IncludeEmbed(GameEmbed embed);
        ...
        /// <param name="embed"></param>
        /// <returns></returns>
        IGamesClient IncludeCategoryEmbed(CategoryEmbed embed);
        ...
        /// <param name="embed"></param>
        /// <returns></returns>
        IGamesClient IncludeLevelEmbed(LevelEmbed embed);
        ...
        /// <returns></returns>
        IGamesClient IncludeEmbeds(List<GameEmbed> embeds);
        ...
        /// <param name="embed"></param>
        /// <returns></returns>
        IGamesClient IncludeCategoryEmbeds(List<CategoryEmbed> embeds);
        ...
        /// <param name="embed"></param>
        /// <returns></returns>
        IGamesClient IncludeLevelEmbeds(List<LevelEmbed> embeds);
